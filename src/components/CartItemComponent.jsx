  ...
  return (
    <div className='grid grid-cols-4 place-items-center mt-[20px] relative border-b-2 pb-[10px] '>
        <div className='flex gap-[10px] items-center'>
            {/* img */}
            <img src={item.thumbnail} alt={item.title} className='hidden md:flex w-[100px] h-[100px] object-cover rounded-2xl' />
        ...
        {/* remove */}
            ...
            <RxCross2 color='red' size={25} className='absolute right-[0px] top-[0px]' onClick={removeItemHandler} />
